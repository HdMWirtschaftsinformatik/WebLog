...
//			ConnectionType.mySQL;
	...
	public static Connection connection() {
		...
		if (con == null) {
			try {
				/*
				 * Falls die Driver-Klasse nicht vor dieser Klasse geladen wird, ist der
				 * entsprechende Treiber noch nicht registriert. Hiermit wird das Laden
				 * erzwungen, was zur Registrierung einer Instanz beim DriverManager führt.
				 */
